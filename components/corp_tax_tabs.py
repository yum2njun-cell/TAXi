...
def render_corp_tax_tabs(current_page):
    """법인세 관리 탭 헤더 렌더링 - 순수 Streamlit 컴포넌트"""
    ...
    tab_info = {
        ...
        "감가상각비 관리": {
            "icon": "", 
            "page": "pages/corp_depreciation.py"
        },
        "이월결손금": {
            "icon": "",
            "page": "pages/corp_loss_carryforward.py"
        }
    }
...
def render_corp_tax_tabs_simple(current_page):
    """더 간단한 버전의 탭 헤더"""
    
    tab_buttons = [
        ("업무용승용차 관리", "", "pages/corp_vehicle_management.py"),
        ("감가상각비 관리", "", "pages/corp_depreciation.py"),
        ("이월결손금", "", "pages/corp_loss_carryforward.py")
    ]
